...
const country=[ {country: 'Afghanistan', code: '93', iso: 'AF'},
  ...
  return (
    <View style={styles.container} >
      ...
      <TouchableOpacity style={styles.TextInput} onPress={()=>{
        ...
        <Image source={require('../Images/arrowD.png')} style={{height:20,width:20}}/>
    }
      </TouchableOpacity>
    {
        isClicked ? <View style={styles.DropDownArea}> 
        <TextInput placeholder='Search' style={styles.serarchInpput} onChangeText={txt=>{
            onsearch(txt);
        }}/>
        <FlatList 
        data={country}
