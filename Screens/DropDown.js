...
export default function DropDown() {
  ...
  const [isClicked, setiscliked] = useState(isClicked);
  ...
  //   if (value || isFocused) {
  //     return (
  //       <Text style={[styles.label1, isFocused && {color: 'blue'}]}>
  //         DropDownlist
  //       </Text>
  //     );
  //   }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.header}>DropDown</Text>
      <TouchableOpacity
        ...
        {isClicked ? (
          ...
          <Image
            source={require('../Images/arrowD.png')}
            style={{height: 20, width: 20}}
          />
        )}
      </TouchableOpacity>
